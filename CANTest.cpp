...
#if VT_LOG
            printf("\n****************************\n");
            printf("VCI_InitCANEx() status (1:ok): %d\n",Status);
            printf("VCI_USBCAN2 = %d:\n", VCI_USBCAN2);
            printf("devIndex = %d: \n",devIndex);
       //     printf("i = %d:",i);
            printf("CANConfig.CAN_ABOM %d:\n", CAN_InitEx.CAN_ABOM);
            printf("CANConfig.CAN_BRP: %d \n",CAN_InitEx.CAN_BRP);
            printf("CANConfig.CAN_BS1:%d\n",CAN_InitEx.CAN_BS1);
            printf("CANConfig.CAN_BS2: %d\n ",CAN_InitEx.CAN_BS2);
            printf("CANConfig.CAN_Mode: %d\n",CAN_InitEx.CAN_Mode);
            printf("CANConfig.CAN_NART: %d\n ",CAN_InitEx.CAN_NART);
            printf("CANConfig.CAN_RELAY: %d\n ",CAN_InitEx.CAN_RELAY);
            printf("CANConfig.CAN_RFLM: %d\n ",CAN_InitEx.CAN_RFLM);
            printf("CANConfig.CAN_SJW: %d\n ",CAN_InitEx.CAN_SJW);
            printf("CANConfig.CAN_TXFP: %d\n ",CAN_InitEx.CAN_TXFP);
#endif
